...
// El switch de "Modo demo" vive en /admin (super-admin) y la conexión del número
// de WhatsApp la provisiona el super-admin por detrás (Meta Business), no el cliente.
const NAV = [
